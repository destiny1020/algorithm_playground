...
/**
 * The partition method was borrowed from algo book, with improvements of sentinels and insertion sort for tiny arrays
 * @author Destiny
 *
 * @param <T>
 */
public class QuickSortStandardSentinelsInsert<T> implements Sortable<T>
{
